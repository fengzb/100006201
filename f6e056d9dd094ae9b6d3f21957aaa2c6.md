...
在[《如何高效管理8000+规模的技术团队》][8000]一文中，有读者留言问道：“文中提到要打造一个数据化管理体系，把IT管理的对象数据化，想请教一下，数据收集的具体维度是什么呢？如何衡量一个工程师的贡献度到底有多大呢？是看代码量，修复bug数量，还是攻克关键问题的数量等，能分享你们的具体做法么？”
...
在[《让细节的“病毒”感染你的团队》][Link 1]一文中，有读者留言问道：“关注细节的确有益于把控系统，但如何保证当技术领导者介入细节后不让团队成员对你形成依赖呢？另外，越级介入一些系统，是否会导致基层员工的不创新、不思考呢？”
...
在[《建立有效的员工淘汰机制》][Link 2]一文中，有读者问道：“对于“合格但不合适”的员工，要怎么处理呢？又该如何确定赔偿方案呢？”
...
在[《定制高效研发流程》][Link 3]一文中，有读者留言问道：“特赞币的做法确实挺好，不过这个虚拟货币的价值是什么呢？各角色为什么要去获取它呢？”
...
在[《 验证研发团队价值的绩效考核机制》][Link 4]一文中，有读者问道：“关于个人OKR部分想请教一下，个人OKR分为个人成长和团队贡献，那制定的个人成长和贡献怎么来评估是合理的，可执行的呢？”
...
在[《CEO实话实说：我需要这样的CTO》][CEO_CTO]一文中，有读者问道：“您提到CTO需要有进化的能力，我理解就是学习能力，大家平时也都会学习，但多数是学了、理解了、用了，就完了，是否需要以学位、证书等方式加持呢？”
...
[8000]: http://time.geekbang.org/column/article/9308
[Link 1]: http://time.geekbang.org/column/article/8273
[Link 2]: http://time.geekbang.org/column/article/8240
[Link 3]: http://time.geekbang.org/column/article/6976
[Link 4]: http://time.geekbang.org/column/article/7916
[CEO_CTO]: http://time.geekbang.org/column/article/5975
